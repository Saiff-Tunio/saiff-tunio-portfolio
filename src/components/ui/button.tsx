  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Futuristic variants for the portfolio
        hero: "bg-glass border border-glass-border text-foreground shadow-lg hover:shadow-xl hover:border-primary/50 hover:bg-glass/80 backdrop-blur-sm",
        ...
        glass: "bg-glass/50 backdrop-blur-sm border border-glass-border text-foreground hover:border-primary/30 hover:bg-glass/60 shadow-lg",
      },
      size: {
