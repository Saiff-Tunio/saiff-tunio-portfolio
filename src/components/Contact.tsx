          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              ...
              <div className="glass-effect rounded-xl p-6 mt-8">
                <h4 className="text-lg font-medium mb-2 text-gradient">Research Collaboration</h4>
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Interested in academic research partnerships, open-source contributions, 
                  or discussing the latest developments in AI/ML? I'm always excited to 
                  connect with fellow researchers and innovators.
                </p>
              </div>
            </div>
          </div>
